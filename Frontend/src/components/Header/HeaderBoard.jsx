...
export default function HeaderBoard({workspaceId}) {
    ...
    return (
        <div className="bg-[#9B4D69] text-white flex items-center justify-between px-4 py-2 relative">
            {/* Left Section */}
                    ...
                    {isMenuOpen && (
                        <div className="absolute top-8 right-0 w-64 bg-white text-gray-700 rounded-lg shadow-lg z-50">
                            ...
                            <div className="p-2">
                                ...
                                <div className="border-t my-2"></div>
                                <button className="w-full flex items-center text-sm p-2 hover:bg-gray-100 rounded text-red-500"
